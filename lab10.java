    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (choice == 2) {
                ...
                Thread m1 = new Thread(a1);
                Thread m2 = new Thread(a2);
                m1.setName("Manger1");
                m1.start();
                try {
                    m1.join();
...
class Employee extends Employee_details implements Runnable {
...
class Manager extends Employee_details implements Runnable {
...
class Payroll extends Employee_details {
    ...
    Payroll(String week_day, int no_of_days, String designation) {
        this(designation);
        int total_ot;
        if (week_day == "Monday" || week_day == "monday" || week_day == "Tuesday" || week_day == "tuesday"
                || week_day == "Wednesday" || week_day == "wednesday" || week_day == "Thursday"
                || week_day == "thursday") {
