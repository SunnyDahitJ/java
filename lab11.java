...
class Employee_details {
    ...
    void al_display()
    {
        LinkedHashMap<String,Object> al = new LinkedHashMap<String,Object>();
    
        al.put("E_id", "101");
        al.put("Ename","Sunny");
        al.put("age", 23);
        al.put("gender", "Male");
        al.put("phon_no", 98783913);
        al.put("marital_status", "single");
        al.put("address", "Bangalore");
        al.put("designation", "developer");
        al.put("start_date", "08/08/2022");
        al.put("C_email", "sun.company@gamail.org");
        al.put("Manager_name", "Dr. Prabhu");
        al.put("Project_assigned","EMS");
        ...
        while(it.hasNext())
        {
            Map.Entry hm1 = (Map.Entry)it.next();
           // System.out.println(hm1.next());         
